...
exports.hasUsefulParse = exports.parseAddressText = void 0;
const PROVINCES = [
    { name: '北京市', aliases: ['北京'] },
    { name: '天津市', aliases: ['天津'] },
    { name: '上海市', aliases: ['上海'] },
 ...
 */
function splitAfterProvince(province, afterProvRaw) {
    ...
    const distMatch = rest.match(/^([\u4e00-\u9fa5]{1,16}(?:开发区|自治县|新区|园区|矿区|林区|景区|新城|区|县|旗))/);
    if (distMatch) {
...
exports.parseAddressText = parseAddressText;
function hasUsefulParse(parsed) {
    return !!(parsed.phone ||
        parsed.province ||
        parsed.city ||
        parsed.district ||
...
exports.hasUsefulParse = hasUsefulParse;
